...
void imnBeginInputAttribute(int id, int s) {
  ImNodes::BeginInputAttribute(id, (ImNodesPinShape)s);
}
void imnEndInputAttribute(void) { ImNodes::EndInputAttribute(); }
void imnBeginOutputAttribute(int id, int s) {
  ImNodes::BeginOutputAttribute(id, (ImNodesPinShape)s);
}
...
void imnPushStyleVarFloat(int sv, float v) {
  ImNodes::PushStyleVar((ImNodesStyleVar)sv, v);
}
